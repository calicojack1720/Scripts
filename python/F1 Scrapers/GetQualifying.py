...
race_type = input("Enter the type of the race: ")
...
if response.status_code == 200:
    ...
    if results_table:
        print(f"Race,Position,Car No,Time,Laps,Session,RaceType")
        ...
        for row in rows:
            ...
            if columns:
                ...
                print(f"{race_name},{position},{car_no},{qone},{laps},1,{race_type}")
                print(f"{race_name},{position},{car_no},{qtwo},{laps},2,{race_type}")
                print(f"{race_name},{position},{car_no},{qthree},{laps},3,{race_type}")
